...
export default function BlogDetailRailway({ onNavigate }) {
  return (
    <div className="page-shell">
      ...
      {/* Hero */}
      <section className="page-hero blog-hero--full page-hero--no-overlay bd-hero-img-fit">
        <div
          className="page-hero__backdrop"
          style={{ backgroundImage: `url(${blogHeroImg})`, backgroundPosition: "center center", backgroundSize: "contain", backgroundRepeat: "no-repeat", backgroundColor: "#060c0a" }}
        >
