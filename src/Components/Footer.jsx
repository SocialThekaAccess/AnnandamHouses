...
const PROJECT_LINKS = [
  { label: "Investor Story", href: "/about-us" },
  { label: "Market Updates", href: "/blog" },
  { label: "Site Visit Booking", href: CONTACT_PATH },
  { label: "Location Guidance", href: CONTACT_PATH },
];
        ...
        <div className="footer__inner">
          <div className="footer__grid">
            <div className="footer__brand">
              ...
              <p className="footer__brand-desc">
                Curated plots, elevated infrastructure, and a polished buying experience for families and investors who expect more.
              </p>
            ...
            <div>
              ...
              <div className="footer__links">
                {QUICK_LINKS.map(({ label, href }) => (
                  <button key={label} className="footer__link" onClick={() => handleNavigate(href)}>
                    {label}
                  </button>
                ))}
              </div>
          ...
          <div className="footer__bottom">
            <p className="footer__copyright">
              &copy; {new Date().getFullYear()} Anandam Homes. All rights reserved. <span>| Anandamhomesofficial@gmail.com</span>
            </p>
            <div className="footer__rera">GujRERA Registered</div>
          </div>
        </div>
      </footer>
